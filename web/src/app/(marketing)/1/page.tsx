...
export default function DesignOne() {
  return (
    <main className="bg-paper text-ink min-h-screen selection:bg-ink selection:text-paper">
      ...
      {/* ── Hero ── */}
      <section className="min-h-screen flex flex-col items-center justify-center px-5 md:px-10 lg:px-20 c-hero">
        <h1 className="font-serif text-7xl md:text-[96px] leading-[0.95] tracking-[-0.03em] text-center">
          Computare
        </h1>
        <div className="w-[120px] h-px bg-gold my-10 md:my-12" />
        <p className="text-ash-600 text-lg md:text-xl max-w-md text-center leading-relaxed">
          Your financial data, on your terms.
        </p>
        <p className="text-ash-400 text-sm mt-4 max-w-sm text-center leading-relaxed">
